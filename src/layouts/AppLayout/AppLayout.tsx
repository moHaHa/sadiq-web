	...
	return (
		<div className='d-flex  flex-column h-100vh font-sans '>
			<AppLayoutGroup.UI.Header>
				<AppLayoutGroup.UI.HeaderTitle text={title}></AppLayoutGroup.UI.HeaderTitle>
			...
			<AppLayoutGroup.UI.Nav>
				...
				<AppLayoutGroup.UI.NavItem link='/add-issue' icon='i-solar:add-circle-broken'></AppLayoutGroup.UI.NavItem>
				<AppLayoutGroup.UI.NavItem
					onClick={() => {
						setOpen(!open);
					}}
					icon={open ? 'i-solar:close-circle-line-duotone' : 'i-solar:hamburger-menu-line-duotone'}
				></AppLayoutGroup.UI.NavItem>
				<AppLayoutGroup.Menu onClose={() => setOpen(false)} open={open}></AppLayoutGroup.Menu>
			</AppLayoutGroup.UI.Nav>
		</div>
	);
};
