...
import { TCitySummary, useCitiesQuery } from '~/server/city/useCitiesQuery';
...
interface CitySelectProps extends Omit<SelectProps, 'value' | 'onChange'> {
...
const CitySelect: FC<CitySelectProps> = ({ value, onChange, valueWithName, init, ...rest }) => {
	const [searchQuery, setSearchQuery] = useState('');
	const [debouncedSearchValue, setDebouncedSearchValue] = useState('');
	const [items, setItems] = useState<TCitySummary[]>([]);
